...
export interface ThemeToggleButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'onClick'> {
  theme?: 'light' | 'dark';
  showLabel?: boolean;
...
export const ThemeToggleButton = ({
  ...
  const computedAriaLabel = ariaLabelProp ?? `Switch to ${theme === 'light' ? 'dark' : 'light'} theme`;
