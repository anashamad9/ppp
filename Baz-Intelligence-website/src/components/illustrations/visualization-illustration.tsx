export const VisualizationIllustration = () => {
    return (
        <div
            aria-hidden
            className="mask-b-from-75% group px-4 pt-4 [--color-primary:var(--color-indigo-500)]">
            <div className="bg-illustration ring-border-illustration relative z-10 rounded-xl p-6 shadow-xl shadow-black/10 ring-1">
                <div className="text-foreground font-medium">Learning Signals</div>
                <div className="text-muted-foreground mt-0.5 text-sm">Corrections, approvals, and repeated outcomes</div>
                <div className="relative my-6 grid grid-cols-[auto_1fr] gap-3 border-l">
                    ...
                    <div className="**:rounded space-y-3">
                        <div className="grid grid-cols-[1fr_auto] items-center gap-2">
                            <div className="bg-linear-to-r from-primary inset-ring-foreground/10 inset-ring-1 h-5 w-full to-[#3b9eff] p-0.5 shadow-lg shadow-black/15">
                            ...
                            <span className="text-muted-foreground text-xs">84%</span>
                        </div>
                        <div className="grid w-2/3 grid-cols-[1fr_auto] items-center gap-2">
                            ...
                            <span className="text-muted-foreground text-xs">61%</span>
                        </div>
                        <div className="grid w-2/5 grid-cols-[1fr_auto] items-center gap-2">
                            ...
                            <span className="text-muted-foreground text-xs">38%</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-1 border-t border-dashed pt-6">
                    <div className="grid grid-cols-[auto_1fr] items-center gap-2">
                        ...
                        <div className="line-clamp-1 text-sm font-medium">
                            Approved answers <span className="text-muted-foreground">(84%)</span>
                        </div>
                    </div>
                    <div className="grid grid-cols-[auto_1fr] items-center gap-2">
                        <div className="bg-primary size-1.5 rounded-full"></div>
                        <div className="line-clamp-1 text-sm font-medium">
                            New workflow patterns <span className="text-muted-foreground">(38%)</span>
                        </div>
                    </div>
                </div>
            </div>
