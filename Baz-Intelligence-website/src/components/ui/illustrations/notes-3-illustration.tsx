...
export const Notes3Illustration = () => {
    const [tasks, setTasks] = useState([
        { id: 1, text: 'Read inbox', completed: true },
        { id: 2, text: 'Draft report', completed: true },
        { id: 3, text: 'Check CRM', completed: true },
        { id: 4, text: 'Ask approval', completed: false },
        { id: 5, text: 'Send update', completed: false },
    ])
            ...
            <div className="relative">
                ...
                <div className="relative rounded-sm bg-gradient-to-br from-amber-100 to-yellow-200 p-5 pb-12 shadow-lg shadow-amber-900/15 dark:from-amber-300 dark:to-yellow-300">
                    <div className="mb-4 flex items-center justify-between pt-2">
                        <span className="text-sm font-semibold text-amber-950">Agent Skills</span>
