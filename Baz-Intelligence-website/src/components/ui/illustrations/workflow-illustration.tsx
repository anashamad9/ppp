        ...
        <div
            ...
            <div>
                <div className="bg-illustration ring-border-illustration shadow-black/6.5 flex items-center gap-2 rounded-xl p-3 shadow-md ring-1">
                    ...
                    <span className="text-foreground text-sm font-medium">Agent run completed</span>
                </div>
                <div className="relative space-y-4 pl-6 pt-6">
                    ...
                    <div className="relative pl-6">
                        ...
                        <div className="bg-card ring-border-illustration flex items-center gap-2 rounded-xl p-3 shadow ring-1">
                            ...
                            <span className="text-muted-foreground text-xs font-medium">
                                Trigger received <span className="text-foreground/50 pl-0.5 text-xs">12s ago</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="relative pl-6">
                        ...
                        <div className="bg-card ring-border-illustration flex items-center gap-2 rounded-xl p-3 shadow ring-1">
                            ...
                            <span className="text-muted-foreground text-xs font-medium">
                                Task scheduled <span className="text-foreground/50 pl-0.5 text-xs">3s ago</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="relative pl-6">
                        ...
                        <div className="bg-card ring-border-illustration flex items-center gap-2 rounded-xl p-3 shadow ring-1">
                            ...
                            <span className="text-muted-foreground text-xs font-medium">
                                Update sent <span className="text-foreground/50 pl-0.5 text-xs">now</span>
                            </span>
                        </div>
                    </div>
                </div>
