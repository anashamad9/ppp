...
المشكلة اللي بنعرفها كلنا إنه كل ما تفتح جلسة جديدة مع Claude أو Codex، بتبدأ من الصفر. لازم تشرح من الأول شو محتاج، وكيف محتاج إياه، وشو القواعد اللي لازم يمشي عليها. وكل مرة بتعيد نفس الحكي. السكيلز بتحل هالقصة من جذورها.
