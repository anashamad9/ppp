...
هاد منيح لجلسة واحدة. الـ context window يستوعب التبادل كله. بس بمجرّد ما تخلص الجلسة، المحادثة هاي راحت من منظور النموذج. إذا بدّك المساعد يتذكّرك الأسبوع الجاي، أو الشهر الجاي، أو السنة الجاية، لازم تبني هالذاكرة برّا النموذج.
...
**ChatGPT Memory** يستعمل نهج profile مهيكل مع تلخيص دوري. النموذج يقرر شو يستحق الحفظ بنهاية المحادثات ويكتبه لمخزن ذاكرة يُحقن كـ system context في الجلسات المستقبلية. المستخدمون يقدروا يشوفوا ويعدّلوا هاي الذكريات مباشرة.
